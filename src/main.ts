...
app.post("/pagamento",async(req,res)=>{  
    try{
        ...
        const [result,fields]  = await conexao.query("INSERT INTO cliente VALUES (?,?,?,?,?)",[idpagamento,formapag,descricao,valor])
        await conexao.end()
        res.send(result)
    }catch(e){
        console.log(e)
...
app.post("/estoque",async(req,res)=>{  
    try{
        ...
        const [result,fields]  = await conexao.query("INSERT INTO cliente VALUES (?,?,?,?,?)",[itemId,nomeProduto,quantidade,localizacao])
        await conexao.end()
        res.send(result)
    }catch(e){
        console.log(e)
...
app.post("/promocoes",async(req,res)=>{  
    try{
        ...
        const [result,fields]  = await conexao.query("INSERT INTO cliente VALUES (?,?,?,?,?)",[idpromocao,titulo,descricao,validade,cupom])
        await conexao.end()
        res.send(result)
    }catch(e){
        console.log(e)
